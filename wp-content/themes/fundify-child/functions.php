...
function fundify_scripts() {
	...
	wp_enqueue_style( 'fundify-fonts', "$protocol://fonts.googleapis.com/css?family=Oswald|Lato:400,700|Libre+Baskerville:400,700,400italic" );
	...
	if ( is_singular() && comments_open() && get_option( 'thread_comments' ) ) {
		...
		//GERRY MOD FOR PALOOTOO
	wp_register_script( 'my_script', 'https://maps.googleapis.com/maps/api/js?key=AIzaSyDU6nX8tMNGw5WZhl9gxWc6ji1X1zhMT0U&sensor=false');
